...
typewriter
  .pauseFor(1000)
  .typeString('I am an ambitious mechanical engineering undergrad who dreams of exploring the stars.') //Add your own tagline
  .pauseFor(3000)
  .start()
...
var granimInstance = new Granim({
    ...
    image : {
        source: 'assets/galaxy_collision_website_cover.png', //change image for intro section if desired
